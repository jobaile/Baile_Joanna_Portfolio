...
--
-- Host: localhost:3306
-- Generation Time: Dec 10, 2018 at 03:41 AM
...
(5, 'London Squash and Fitness Club', 'In 2018, my class had the opportunity to redesign the LSFC website. The LSFC board members wanted a refreshing site that could attract new members and also create a better user experience for current members. For this project, I was the web developer. I focused on clean design that was also easy to navigate around. ', 'lsfc1.jpg', 'lsfc2.gif', 'Web & Design', 'April 2018', 'The London Squash & Fitness Club (LSFC) was founded in September 1966 and has maintained a focus on squash and fitness as a non-profit, member-owned organization. The club is active throughout the year with member ladders, club tournaments, city league matches, exhibitions, and social events. ', 'lsfc.html'),
